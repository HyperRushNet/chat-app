...
CREATE POLICY "messages_select_room" ON public.messages FOR SELECT USING (true);
...
RETURNS void LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$ BEGIN
    ...
    END IF;
    INSERT INTO public.room_passwords (room_id, password_hash) VALUES (p_room_id, p_hash)
